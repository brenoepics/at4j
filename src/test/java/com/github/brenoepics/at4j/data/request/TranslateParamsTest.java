...
class TranslateParamsTest {
  ...
  void shouldSetAndGetTextType() {
    ...
    assertEquals(TextType.HTML, params.getTextType());
  }
  ...
  void shouldSetAndGetProfanityAction() {
    ...
    assertEquals(ProfanityAction.MARKED, params.getProfanityAction());
  }
  ...
  void shouldSetAndGetProfanityMarker() {
    ...
    assertEquals(ProfanityMarker.TAG, params.getProfanityMarker());
  }
