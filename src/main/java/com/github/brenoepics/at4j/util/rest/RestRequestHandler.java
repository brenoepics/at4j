 ...
 * It stores the result of a REST request, the current request being processed, and the timestamp of the response.
 *
...
public class RestRequestHandler<T> {
		 ...
		 */
		public RestRequestHandler(RestRequestResult result, RestRequest<T> currentRequest, long responseTimestamp) {
				this.result = result;
