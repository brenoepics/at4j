 ...
 * API Errors</a>. <br>
 * The error code is a 6-digit number combining the <b>3-digit HTTP status
 * code</b> followed by a <b>3-digit number to further categorize the error</b>.
 */
public enum RestRequestResultErrorCode {
  TARGET_LANGUAGE_NOT_VALID(
      ...
      BadRequestException::new, RestRequestHttpResponseCode.BAD_REQUEST),
  ...
  REQUEST_INPUT_INVALID(400000, "One of the request inputs isn't valid.",
                        BadRequestException::new,
                        RestRequestHttpResponseCode.BAD_REQUEST),
  SCOPE_PARAMETER_INVALID(400001, "The \"scope\" parameter is invalid.",
                          BadRequestException::new,
                          RestRequestHttpResponseCode.BAD_REQUEST),
  CATEGORY_PARAMETER_INVALID(400002, "The \"category\" parameter is invalid.",
                             BadRequestException::new,
                             RestRequestHttpResponseCode.BAD_REQUEST),
  LANGUAGE_SPECIFIER_INVALID(400003,
  ...
  TARGET_SCRIPT_SPECIFIER_INVALID(
      ...
      BadRequestException::new, RestRequestHttpResponseCode.BAD_REQUEST),
  INPUT_TEXT_INVALID(400005, "An input text is missing or invalid.",
                     BadRequestException::new,
                     RestRequestHttpResponseCode.BAD_REQUEST),
  ...
  SPECIFIED_LANGUAGE_PAIR_INVALID(
      ...
      BadRequestException::new, RestRequestHttpResponseCode.BAD_REQUEST),
  SOURCE_LANGUAGE_INVALID(400035,
  ...
  TARGET_SCRIPTS_NOT_MATCH_TARGET_LANGUAGES(
      ...
      BadRequestException::new, RestRequestHttpResponseCode.BAD_REQUEST),
  TEXT_TYPE_INVALID(400071, "The value isn't valid for TextType.",
                    BadRequestException::new,
                    RestRequestHttpResponseCode.BAD_REQUEST),
  INPUT_TEXT_ARRAY_TOO_MANY_ELEMENTS(
      400072, "The array of input text has too many elements.",
      BadRequestException::new, RestRequestHttpResponseCode.BAD_REQUEST),
  SCRIPT_PARAMETER_INVALID(400073, "The script parameter isn't valid.",
                           BadRequestException::new,
                           RestRequestHttpResponseCode.BAD_REQUEST),
  ...
  REQUEST_NOT_AUTHORIZED(
      ...
      UnauthorizedException::new, RestRequestHttpResponseCode.UNAUTHORIZED),
  WRONG_CREDENTIALS_PROVIDED(
      ...
      UnauthorizedException::new, RestRequestHttpResponseCode.UNAUTHORIZED),
  OPERATION_NOT_ALLOWED(403000, "The operation isn't allowed.",
  ...
  FREE_QUOTA_EXCEEDED(
      ...
      ForbiddenException::new, RestRequestHttpResponseCode.FORBIDDEN),
  ...
  /**
   * The azure exception instantiate that produces instances to throw for this
   * kind of result code.
   */
  private final AzureExceptionInstantiation<AzureException>
      azureExceptionInstantiation;
  ...
  static {
    instanceByCode = Collections.unmodifiableMap(
        Arrays.stream(values()).collect(Collectors.toMap(
            RestRequestResultErrorCode::getCode, Function.identity())));
  }
   ...
   * @param code The actual numeric close code.
   * @param meaning The textual meaning.
   * @param azureExceptionInstantiation The azure exception instantiating that
   *     produces instances to throw for this kind of result code.
   * @param responseCode The response code for which the given instantiating
   *     should be used.
   */
   ...
   */
  public static Optional<RestRequestResultErrorCode>
  fromCode(String code, RestRequestHttpResponseCode responseCode) {
   ...
   * @see <a href="https://brenoepics.github.io/at4j/error-reference/">Error
   *     Reference</a>
   */
   ...
   */
  public RestRequestHttpResponseCode getResponseCode() { return responseCode; }
   ...
   */
  public Optional<AzureException>
  getAzureException(Exception origin, String message, RestRequestInfo request,
    ...
    return Optional.ofNullable(azureExceptionInstantiation)
        .map(instantiate
             -> instantiate.createInstance(origin, message, request, response))
        .filter(exception
                -> RestRequestHttpResponseCode
                       .fromAzureExceptionClass(exception.getClass())
