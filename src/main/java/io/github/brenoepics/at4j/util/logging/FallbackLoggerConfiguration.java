...
/** This class can be used to configure AT4J's fallback logger. */
public class FallbackLoggerConfiguration {
  ...
  /**
   * Sets whether debug logging should be enabled. Disabling debug logging automatically disables
   * trace logging, too.
   *
  ...
  /**
   * Sets whether trace logging should be enabled. Enabling trace logging automatically enables
   * debug logging, too.
   *
