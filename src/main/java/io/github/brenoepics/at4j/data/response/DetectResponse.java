...
/**
 * This class represents a response from a language detection operation. It contains a list of
 * detected languages.
 */
public class DetectResponse {
  ...
  /** Constructor for DetectResponse. Initializes the list of detected languages. */
