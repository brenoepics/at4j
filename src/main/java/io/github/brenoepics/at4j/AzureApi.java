...
/**
 * This class is the most important class of AT4J, as it contains the main
...
public interface AzureApi {
   ...
   * Use with multi-service and regional translator resource. The value is the
   * region of the multi-service or regional translator resource. This value is
   * optional when using a global translator resource.
   *
   * @return String - The used subscription region.
   * @see <a
   *     href="https://github.com/brenoepics/at4j/main/docs/azure_datacenter_list.json">Azure
   *     Datacenter List</a>
   */
   ...
   *     Support</a>
   */
  CompletableFuture<Optional<Collection<Language>>>
   ...
   * The entire text included in the request can't exceed 50,000 characters
   * including spaces.
   *
   ...
   *     Detection</a>
   */
  CompletableFuture<Optional<DetectResponse>>
