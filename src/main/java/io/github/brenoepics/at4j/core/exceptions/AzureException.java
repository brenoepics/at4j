...
public class AzureException extends Exception {
  ...
  /**
   * The request. May be <code>null</code> if the exception was thrown before
   * creating a request.
   */
  private final transient RestRequestInfo request;

  /**
   * The rest request result. May be <code>null</code> if the exception was
   * thrown before sending a request.
   */
   ...
   */
  public AzureException(Exception origin, String message,
  ...
  /**
   * Gets information about the request which caused the exception. May be
   * <code>null</code> if the exception was thrown before creating a request.
   *
  ...
  /**
   * Gets information about the response which caused the exception. May not be
   * present if the exception was thrown before sending a request.
   *
