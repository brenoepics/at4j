 ...
 * <a href="https://learn.microsoft.com/en-us/azure/ai-services/translator/reference/v3-0-reference#errors">Azure</a>.
 */
public enum RestRequestHttpResponseCode {
     ...
     */
    private static final Map<Class<? extends AzureException>, RestRequestHttpResponseCode> instanceByExceptionClass;
    ...
    <T extends AzureException> RestRequestHttpResponseCode(
            ...
            AzureExceptionInstantiator<T> AzureExceptionInstantiator, Class<T> AzureExceptionClass) {
        this.code = code;
        ...
        if ((AzureExceptionInstantiator == null) && (AzureExceptionClass != null)
            ...
            throw new IllegalArgumentException("AzureExceptionInstantiator and AzureExceptionClass do not match");
        }
    }
     ...
     * {@code AzureException} is reached.
     *
