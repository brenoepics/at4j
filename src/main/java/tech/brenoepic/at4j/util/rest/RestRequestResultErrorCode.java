 ...
 * <a href="https://learn.microsoft.com/en-us/azure/ai-services/translator/reference/v3-0-reference#errors">Azure API Errors</a>.
 * <br>
 * The error code is a 6-digit number combining the <b>3-digit HTTP status code</b> followed by a <b>3-digit number to further categorize the error</b>.
 */
public enum RestRequestResultErrorCode {
     ...
     * @param code                         The actual numeric close code.
     * @param meaning                      The textual meaning.
     * @param azureExceptionInstantiator The azure exception instantiator that produces
     ...
     */
    RestRequestResultErrorCode(int code, String meaning, AzureExceptionInstantiator<?> azureExceptionInstantiator,
     ...
     */
    public Optional<? extends AzureException> getAzureException(Exception origin, String message,
        ...
        return Optional.ofNullable(azureExceptionInstantiator)
                ...
                .filter(exception -> RestRequestHttpResponseCode.fromAzureExceptionClass(exception.getClass())
