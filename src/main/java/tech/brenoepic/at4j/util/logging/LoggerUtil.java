    ...
    public static Logger getLogger(String name) {
        ...
        if (noLogger.get()) {
            return loggers.computeIfAbsent(name, key -> {
                Level debugLevel = FallbackLoggerConfiguration.isDebugEnabled() ? Level.DEBUG : Level.INFO;
                ...
                if (logWarning.get()) {
                    logger.info("No Log4j2 compatible logger was found. Using default AT4J implementation!");
                }
