 ...
 * The list of available domains can be found
 * <a href="https://learn.microsoft.com/en-us/azure/ai-services/translator/reference/v3-0-reference#base-urls">here</a>.
 */
public enum BaseURL {

    /**
     * The default domain of the Azure Translator API.
     * Datacenters: Closest available datacenter.
     */
    GLOBAL("api.cognitive.microsofttranslator.com"),

    /**
     * The domain of the Azure Translator API for the Asia Pacific.
     * Datacenters: Korea South, Japan East, Southeast Asia, and Australia East.
     */
    ASIA_PACIFIC("api-apc.cognitive.microsofttranslator.com"),

    /**
     * The domain of the Azure Translator API for the Europe.
     * Datacenters: North Europe and West Europe.
     */
