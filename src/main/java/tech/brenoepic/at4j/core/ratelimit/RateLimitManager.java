...
public class RateLimitManager {
            ...
            while (currentRequest != null) {
                try {
                    ...
                    if (t instanceof AzureException) {
                        result = ((AzureException) t).getResponse()
    ...
    private void handleResponse(
        ...
        boolean global = Objects.requireNonNull(response.header("X-RateLimit-Global", "false")).equalsIgnoreCase("true");
        ...
        if (result.getResponse().code() == 429) {
            ...
            if (global) {
                ...
                logger.warn("Hit a global rate-limit! This means you were sending a very large "
